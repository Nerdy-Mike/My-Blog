...
export default function Footer() {
  return (
    <footer className="w-screen ">
      <div className="mx-12 mt-12 flex flex-col items-center border-t border-gray-200 dark:border-gray-700">
        ...
        <div className="text-md mb-4  text-center text-gray-600 dark:text-gray-400 ">
