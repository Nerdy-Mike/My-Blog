...
date: '2022-03-20'
category: 'Tutorials'
tags: ['nextjs', 'guide', 'images', 'beginner']
draft: false
...
Assuming we have a file called `ocean.jpg` in `public/static/images/ocean.jpg`, the following line of code would generate the optimized image.
